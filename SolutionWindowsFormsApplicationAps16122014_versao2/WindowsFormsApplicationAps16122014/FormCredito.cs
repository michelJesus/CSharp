...
namespace WindowsFormsApplicationAps16122014
{
    public partial class FormCredito : Form
    {
        ...
        private void btnIncluirCredito_Click(object sender, EventArgs e)
        {
            ...
            novoCredito.DataCredito = dtpDataCredito.Value;
            novoCredito.ValorCredito = Convert.ToDecimal(txtValorCredito.Text);

            contaSelecionada.SaldoConta = contaSelecionada.SaldoConta + Convert.ToDecimal(txtValorCredito.Text);
        ...
        {
            creditoSelecionado.DataCredito = dtpDataCredito.Value;
        ...
        {
           // creditoSelecionado.DataCredito = dtpDataCredito.Text;
           // creditoSelecionado.ValorCredito = decimal.Parse(txtValorCredito.Text);
        ...
        private void txtContaId_KeyUp(object sender, KeyEventArgs e)
        {
            contaSelecionada = db.Contas.Find(int.Parse(txtContaId.Text));
            //txtNomeConta.Text = contaSelecionada.Pessoa.NomePessoa;
        ...
        {
            Credito credCredito = new Credito();
            credCredito.DataCredito = dtpDataCredito.Value;
            credCredito.ValorCredito = Convert.ToDecimal(txtValorCredito.Text);
