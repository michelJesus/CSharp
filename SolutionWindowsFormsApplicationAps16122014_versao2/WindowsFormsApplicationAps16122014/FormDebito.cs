...
namespace WindowsFormsApplicationAps16122014
{
    public partial class FormDebito : Form
    {
        ...
        private void btnIncluirDebito_Click(object sender, EventArgs e)
        {
            ...
            contaSelecionada.SaldoConta = contaSelecionada.SaldoConta - Convert.ToDecimal(txtValorDebito.Text);
        ...
        private void txtContaDebito_KeyUp(object sender, KeyEventArgs e)
        {
            contaSelecionada = db.Contas.Find(int.Parse(txtContaDebito.Text));
        }
    }
}
